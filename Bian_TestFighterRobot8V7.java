...
public class Bian_TestFighterRobot8V7 extends FighterRobot {
	private int health;
	private int round;
	 ...
	 */
	public Bian_TestFighterRobot8V7(City c, int a, int s, Direction d, int id, int health) {
		super(c, a, s, d, id, 1, 5, 4); // City c, int a, int s, Direction d, int id, int attack, int defence, int numMoves
		this.health = health;
		this.setLabel();
	}
