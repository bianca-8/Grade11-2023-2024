...
public class Bian_TestFighterRobot3V3 extends FighterRobot {
	private int health;
	private int round;
	 ...
	 */
	public Bian_TestFighterRobot3V3(City c, int a, int s, Direction d, int id, int health) {
	...
	public TurnRequest takeTurn(int energy, OppData[] data) {
		...
		if (fightID != -1 && (this.round >= this.ROUNDPENALTY - 1 || movesLeft <= this.ROUNDPENALTY - 2)) {  //this.health >= FIGHTHEALTH ||  -- CAN ADD IN (WAS OR)
