...
public class Bian_TestFighterRobot6 extends FighterRobot {
	private int health;
	private int round;
	 ...
	 */
	public Bian_TestFighterRobot6(City c, int a, int s, Direction d, int id, int health) {
	...
	public TurnRequest takeTurn(int energy, OppData[] data) {
		...
		// sorting lists 
		// find closest lowest health player which lost the most battles
		selectSort(this.mydata);
