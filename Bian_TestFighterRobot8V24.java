...
public class Bian_TestFighterRobot8V24 extends FighterRobot {
	private int health;
	private int round;
	 ...
	 */
	public Bian_TestFighterRobot8V24(City c, int a, int s, Direction d, int id, int health) {
		super(c, a, s, d, id, 3, 3, 4); // City c, int a, int s, Direction d, int id, int attack, int defence, int numMoves
		this.health = health;
		this.setLabel();
	}
