...
public class Bian_TestFighterRobot8V26 extends FighterRobot {
	private int health;
	private int round;
	 ...
	 */
	public Bian_TestFighterRobot8V26(City c, int a, int s, Direction d, int id, int health) {
		super(c, a, s, d, id, 3, 4, 3); // City c, int a, int s, Direction d, int id, int attack, int defence, int numMoves
		this.health = health;
		this.setLabel();
	}
